...
class cnn_model_struct:
    ...
    #     #     #if train_mode:
    #     #     self.norm7 = tf.layers.batch_normalization(self.conv2d(self.h_pool6, self.W_conv7,stride=[1,1,1,1]) + self.b_conv7, scale=True,center=True,training=train_mode)
    #     #     self.h_conv7 = tf.nn.leaky_relu(self.norm7, alpha=0.1)
    #     #     #else:
    #     #     #    self.h_conv7 = tf.nn.leaky_relu(self.conv2d(self.h_pool6, self.W_conv7,stride=[1,1,1,1]) + self.b_conv7, alpha=0.1)
    #     #
    ...
    #     #     #if train_mode:
    #     #     self.norm8 = tf.layers.batch_normalization(self.conv2d(self.h_conv7, self.W_conv8,stride=[1,1,1,1]) + self.b_conv8, scale=True,center=True,training=train_mode)
    #     #     self.h_conv8 = tf.nn.leaky_relu(self.norm8, alpha=0.1)
    #     #     #else:
    #     #     #    self.h_conv8 = tf.nn.leaky_relu(self.conv2d(self.h_conv7, self.W_conv8,stride=[1,1,1,1]) + self.b_conv8, alpha=0.1)
    #     #
    ...
    #     #
    #     #     #self.h_conv9 = tf.matmul(self.h_conv8, self.W_conv9) + self.b_conv9
    #     #     # if train_mode:
    #     #     #     self.h_conv9 = tf.layers.batch_normalization(self.conv2d(self.h_conv8, self.W_conv9, stride=[1, 1, 1, 1]) + self.b_conv9, scale=True,center=True,training=True)
    #     #     # else:
    #     #     #     self.h_conv9 = self.conv2d(self.h_conv8, self.W_conv9, stride=[1, 1, 1, 1]) + self.b_conv9

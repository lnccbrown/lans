...
class classification_model:
	...
	if verbose:
        ...
        self.fc3 = self.fc_layer(self.fc2, self.get_size(self.fc2), 64, 'fc3')
	if verbose:
            print(self.fc3.get_shape())

	nparams = np.prod(output_shape)
        self.final_layer = self.fc_layer(self.fc3, self.get_size(self.fc3), nparams, 'final_layer')
...
if __name__ == '__main__':
    cfg = config.Config()
    train_classification_model(cfg)
